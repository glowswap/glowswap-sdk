...
/// @title Canonical GlowSwap V3 factory
/// @notice Deploys GlowSwap V3 pools and manages ownership and control over pool protocol fees
contract GlowV3Factory is IGlowV3Factory {
    /// @inheritdoc IGlowV3Factory
    ...
    function createPool(
        ...
        pool = IGlowV3PoolDeployer(poolDeployer).deploy(address(this), token0, token1, fee, tickSpacing);
    ...
    function setFeeProtocol(
        ...
        IGlowV3Pool(pool).setFeeProtocol(feeProtocol0, feeProtocol1);
    }
    ...
    function collectProtocol(
        ...
        return IGlowV3Pool(pool).collectProtocol(recipient, amount0Requested, amount1Requested);
    }

    function setLmPool(address pool, address lmPool) external override onlyOwnerOrLmPoolDeployer {
        IGlowV3Pool(pool).setLmPool(lmPool);
    }
}

...
contract GlowV3PoolDeployer is IGlowV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc IGlowV3PoolDeployer
    ...
    /// @param factory The contract address of the GlowSwap V3 factory
    ...
    function deploy(
        ...
        pool = address(new GlowV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}

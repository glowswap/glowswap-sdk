...
describe('GlowV3Pool', () => {
  ...
  let pool0: MockTimeGlowV3Pool
  let pool1: MockTimeGlowV3Pool
  ...
  let swapTargetCallee: TestGlowV3Callee
  let swapTargetRouter: TestGlowV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeGlowV3Pool, any]> => {

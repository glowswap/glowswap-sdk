import { abi as IGlowV3PoolABI } from '@glowswap/v3-core/artifacts/contracts/interfaces/IGlowV3Pool.sol/IGlowV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IGlowV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IGlowV3Pool, IGlowV3Pool, IGlowV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IGlowV3PoolABI, wallet)) as [
      IGlowV3Pool,
      IGlowV3Pool,
      IGlowV3Pool
    ]
  ...
  let pools: [IGlowV3Pool, IGlowV3Pool, IGlowV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestGlowV3Callee')

...
import '@glowswap/v3-core/contracts/interfaces/callback/IGlowV3FlashCallback.sol';
...
/// @notice An example contract using the glowswap V3 flash function
contract PairFlash is IGlowV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `GlowV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        ...
        IGlowV3Pool pool = IGlowV3Pool(PoolAddress.computeAddress(deployer, poolKey));

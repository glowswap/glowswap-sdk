...
import './interfaces/IGlowV3PoolDeployer.sol';
import './interfaces/IGlowV3Factory.sol';
...
import '@glowswap/v3-lm-pool/contracts/interfaces/IGlowV3LmPool.sol';

contract GlowV3Pool is IGlowV3Pool {
    ...
    /// @inheritdoc IGlowV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IGlowV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IGlowV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IGlowV3PoolDerivedState
    ...
    function mint(
        ...
        IGlowV3MintCallback(msg.sender).glowV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IGlowV3SwapCallback(msg.sender).glowV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IGlowV3FlashCallback(msg.sender).glowV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IGlowV3PoolOwnerActions

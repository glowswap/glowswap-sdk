...
import V3PoolArtifact from "@glowswap/v3-core/artifacts/contracts/GlowV3Pool.sol/GlowV3Pool.json";
import V3PoolDeployerArtifact from "@glowswap/v3-core/artifacts/contracts/GlowV3PoolDeployer.sol/GlowV3PoolDeployer.json";
import V3FactoryArtifact from "@glowswap/v3-core/artifacts/contracts/GlowV3Factory.sol/GlowV3Factory.json";
import SwapRouterArtifact from "@glowswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json";
import NonfungiblePositionManagerArtifact from "@glowswap/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json";
import V3LmPoolDeployerArtifact from "@glowswap/v3-lm-pool/artifacts/contracts/GlowV3LmPoolDeployer.sol/GlowV3LmPoolDeployer.json";
import ERC20MockArtifact from "./Token.json";
import WVICEArtifact from "./WVIC.json";
import MultiCallArtifact from "@glowswap/v3-periphery/artifacts/contracts/lens/GlowInterfaceMulticall.sol/GlowInterfaceMulticall.json";

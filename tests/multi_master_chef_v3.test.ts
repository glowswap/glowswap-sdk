...
import { GlowV3Pool } from '../src/GlowV3Pool';


describe('multi_master_chef_v3', () => {
    const contractConfig = buildtContracConfig()

    const poolAddress = '0x98aef5ab0af1e1f7ddd375f0e85a192c9e74efeb'
    const tokenId = 54n
    ...
    const pool = new GlowV3Pool(currPublicClient, poolAddress)

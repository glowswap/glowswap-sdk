...
import { GlowV3Pool } from '../src';

describe('Position', () => {
    const contractConfig = buildtContracConfig()

    // USDT-USDC-100
    const poolAddress = '0x90B63dA86dD57Eb61e6E022a487a5172c354F945'
    const tokenId = 4n
    ...
    const glowV3Pool = new GlowV3Pool(currPublicClient, poolAddress)
    ...
    test('increaseLiquidity', async () => {
        const slot0 = await glowV3Pool.getSlot0()
